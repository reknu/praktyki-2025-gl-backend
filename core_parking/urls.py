...
from .views.reservation import CreateReservation, UserReservationsList, LatestFiveReservations
...
urlpatterns = [
    ...
    path('reservations/create/', CreateReservation.as_view(), name='reservation-list'), # co robi samo reservations, tworzy moze?
